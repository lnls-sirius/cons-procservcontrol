...
drvAsynIPPortConfigure("P1",  "10.128.124.140:20202", 100, 0, 0)
drvAsynIPPortConfigure("P2",  "10.128.124.140:20206", 100, 0, 0)
drvAsynIPPortConfigure("P3",  "10.128.124.140:20208", 100, 0, 0)
drvAsynIPPortConfigure("P4",  "10.128.128.141:20200", 100, 0, 0)
drvAsynIPPortConfigure("P5",  "10.128.124.160:20200", 100, 0, 0)
drvAsynIPPortConfigure("P6",  "10.128.124.161:20200", 100, 0, 0)
drvAsynIPPortConfigure("P7",  "10.128.124.162:20200", 100, 0, 0)
drvAsynIPPortConfigure("P8",  "10.128.124.163:20200", 100, 0, 0)
drvAsynIPPortConfigure("P9",  "10.128.124.164:20200", 100, 0, 0)
...
drvAsynIPPortConfigure("P14",  "10.128.255.4:21003", 100, 0, 0)
drvAsynIPPortConfigure("P15",  "10.128.255.4:21004", 100, 0, 0)
drvAsynIPPortConfigure("P16",  "10.128.255.4:21005", 100, 0, 0)
drvAsynIPPortConfigure("P17",  "10.128.255.4:21006", 100, 0, 0)
drvAsynIPPortConfigure("P18",  "10.128.255.4:21007", 100, 0, 0)
drvAsynIPPortConfigure("P19",  "10.128.255.4:21008", 100, 0, 0)
drvAsynIPPortConfigure("P20",  "10.128.255.4:21009", 100, 0, 0)
drvAsynIPPortConfigure("P21",  "10.128.255.4:21010", 100, 0, 0)
...
dbLoadRecords("db/procServControl.db","P=ProcCtrl:SR-RF-DLLRF-01,PORT=P4,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:SR-RF-DLLRF-01")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:ToBO-SSA01,PORT=P5,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:ToBO-SSA01")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:ToSI-SSA01,PORT=P6,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:ToSI-SSA01")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:ToSI-SSA02,PORT=P7,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:ToSI-SSA02")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:RA-RaBO01:RF-LLRFCalSys,PORT=P8,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:RA-RaBO01:RF-LLRFCalSys")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:RA-RaBO01:RF-LLRFPlDrivers,PORT=P9,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:RA-RaBO01:RF-LLRFPlDrivers")
...
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-04:PU-InjSeptG-1,PORT=P14,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-04:PU-InjSeptG-1")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-04:PU-InjSeptG-2,PORT=P15,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-04:PU-InjSeptG-2")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-04:PU-InjSeptF,PORT=P16,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-04:PU-InjSeptF")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:SI-01SA:PU-InjDpKckr,PORT=P17,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:SI-01SA:PU-InjDpKckr")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:SI-01SA:PU-InjNLKckr,PORT=P18,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:SI-01SA:PU-InjNLKckr")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:BO-48D:PU-EjeKckr,PORT=P19,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:BO-48D:PU-EjeKckr")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-01:PU-EjeSeptF,PORT=P20,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-01:PU-EjeSeptF")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-01:PU-EjeSeptG,PORT=P21,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-01:PU-EjeSeptG")
