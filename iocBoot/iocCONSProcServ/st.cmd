...
drvAsynIPPortConfigure("P16",  "10.128.255.4:21003", 100, 0, 0)
drvAsynIPPortConfigure("P17",  "10.128.255.4:21004", 100, 0, 0)
drvAsynIPPortConfigure("P18",  "10.128.255.4:21005", 100, 0, 0)
drvAsynIPPortConfigure("P19",  "10.128.255.4:21006", 100, 0, 0)
drvAsynIPPortConfigure("P20",  "10.128.255.4:21007", 100, 0, 0)
drvAsynIPPortConfigure("P21",  "10.128.255.4:21010", 100, 0, 0)
drvAsynIPPortConfigure("P22",  "10.128.255.4:21011", 100, 0, 0)
drvAsynIPPortConfigure("P23",  "10.128.255.4:21012", 100, 0, 0)
drvAsynIPPortConfigure("P24",  "10.128.255.4:21013", 100, 0, 0)
drvAsynIPPortConfigure("P25",  "10.128.255.4:21014", 100, 0, 0)
drvAsynIPPortConfigure("P26",  "10.128.255.58:20200", 100, 0, 0)
drvAsynIPPortConfigure("P27",  "10.128.255.59:20200", 100, 0, 0)
drvAsynIPPortConfigure("P28",  "10.128.255.60:20200", 100, 0, 0)
...
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-04:PU-InjSeptG-1,PORT=P16,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-04:PU-InjSeptG-1")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-04:PU-InjSeptG-2,PORT=P17,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-04:PU-InjSeptG-2")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-04:PU-InjSeptF,PORT=P18,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-04:PU-InjSeptF")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:SI-01SA:PU-PingH,PORT=P19,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:SI-01SA:PU-PingH")
...
dbLoadRecords("db/procServControl.db","P=ProcCtrl:BO-48D:PU-EjeKckr,PORT=P22,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:BO-48D:PU-EjeKckr")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-01:PU-EjeSeptF,PORT=P23,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-01:PU-EjeSeptF")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-01:PU-EjeSeptG,PORT=P24,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-01:PU-EjeSeptG")
