...
drvAsynIPPortConfigure("P12",  "10.128.124.140:20210", 100, 0, 0)
drvAsynIPPortConfigure("P13",  "10.128.255.4:21001", 100, 0, 0)
drvAsynIPPortConfigure("P14",  "10.128.255.4:21002", 100, 0, 0)
drvAsynIPPortConfigure("P15",  "10.128.255.4:21008", 100, 0, 0)
drvAsynIPPortConfigure("P16",  "10.128.255.4:21009", 100, 0, 0)
drvAsynIPPortConfigure("P17",  "10.128.255.4:21010", 100, 0, 0)
drvAsynIPPortConfigure("P18",  "10.128.255.4:21003", 100, 0, 0)
drvAsynIPPortConfigure("P19",  "10.128.255.4:21004", 100, 0, 0)
drvAsynIPPortConfigure("P20",  "10.128.255.4:21005", 100, 0, 0)
drvAsynIPPortConfigure("P21",  "10.128.255.4:21006", 100, 0, 0)
drvAsynIPPortConfigure("P22",  "10.128.255.4:21007", 100, 0, 0)
drvAsynIPPortConfigure("P23",  "10.128.255.4:21011", 100, 0, 0)
drvAsynIPPortConfigure("P24",  "10.128.255.58:20200", 100, 0, 0)
drvAsynIPPortConfigure("P25",  "10.128.255.59:20200", 100, 0, 0)
drvAsynIPPortConfigure("P26",  "10.128.255.60:20200", 100, 0, 0)
...
dbLoadRecords("db/procServControl.db","P=ProcCtrl:P7WaterCalc,PORT=P12,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:P7WaterCalc")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TB-04:PU-InjSept,PORT=P13,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TB-04:PU-InjSept")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:BO-01D:PU-InjKckr,PORT=P14,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:BO-01D:PU-InjKckr")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:BO-48D:PU-EjeKckr,PORT=P15,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:BO-48D:PU-EjeKckr")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-01:PU-EjeSeptF,PORT=P16,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-01:PU-EjeSeptF")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-01:PU-EjeSeptG,PORT=P17,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-01:PU-EjeSeptG")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-04:PU-InjSeptG-1,PORT=P18,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-04:PU-InjSeptG-1")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-04:PU-InjSeptG-2,PORT=P19,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-04:PU-InjSeptG-2")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:TS-04:PU-InjSeptF,PORT=P20,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:TS-04:PU-InjSeptF")
...
dbLoadRecords("db/procServControl.db","P=ProcCtrl:SI-19C4:PU-PingV,PORT=P23,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:SI-19C4:PU-PingV")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:Reg-Dip,PORT=P24,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:Reg-Dip")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:Reg-Qua,PORT=P25,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:Reg-Qua")
dbLoadRecords("db/procServControl.db","P=ProcCtrl:Reg-Sex,PORT=P26,SHOWOUT=1,MANUALSTART=,NAME=ProcCtrl:Reg-Sex")
